...
<script src="/js/script2.js"></script>
  ...
  <body class="OfficerRegbdy1">
    <?php include("./partials/nav2.blade.php"); ?>
    <br/><br/> 

      
      <div class="container OfficerRegbdy">
        <h1><center>Sing Up</center></h1>
        <p><b><center>Register officer.</center></b></p>
        <br/><br/>

      
        <form name="OfficerReg" action="RegisterOfficer" method="POST" onsubmit="return validateOfficerReg()">
            @csrf
