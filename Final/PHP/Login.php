<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id FROM customer_logins WHERE user = '$myusername' and pass = '$mypassword'";
      ...
      //   session_register("myusername");
         ...
         header("location: GasVariation.php");
      }else {
   ...
   <body bgcolor = "#FFFFFF" style="background-image: url('img/nature.jpg');background-repeat:no-repeat;background-attachment:fixed;background-size:cover;">
      ...
      <div align = "center" >
         <div style = "width:300px; border: solid 1px #333333;" align = "left" class="fposition">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b><center>Customer Login</center></b></div>
...
<script>
 ...
 function openCA() {
  myWindow = window.open("register.php");
 }
