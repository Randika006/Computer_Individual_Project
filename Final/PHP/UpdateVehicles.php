...
if(count($_POST)>0) {
mysqli_query($db,"UPDATE vehicles_details set  id='" . $_POST['id'] . "', ftype='" . $_POST['ftype'] . "', etype='" . $_POST['etype'] . "', lnum='" . $_POST['lnum'] . "' ,vmodel='" . $_POST['vmodel'] . "' WHERE id='" . $_POST['id'] . "'");
header("location: VehiclesDetails.php");
}
$result = mysqli_query($db,"SELECT * FROM vehicles_details WHERE id='" . $_GET['id'] . "'");
...
<html>
   ...
   <head>
      <title>Vehicles Registration Page</title>
   ...
   <body bgcolor = "#FFFFFF" style="background-image: url('img/nature.jpg');background-repeat:no-repeat;background-attachment:fixed;background-size:cover;">
      ...
      <div align = "center" >
         <div style = "width:300px; border: solid 1px #333333;" align = "left" class="fposition">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b><center>Update Vehicles Registration</center></b></div>
				
            <div style = "margin:30px">
               
               <form action ="" method = "post" name="addData" onsubmit="return validateForm()">
               ...
               <br>
                  ...
                  <label>Fuel Type  :</label><input type = "text" name = "ftype"   value="<?php echo $row['ftype']; ?>" class = "box tsize"/><br /><br />
                  <label>Endine Type  :</label><input type = "text" name = "etype"  value="<?php echo $row['etype']; ?>"   class = "box tsize" /><br/><br />
                  <label>License plate number  :</label><input type = "text" name = "lnum"    value="<?php echo $row['lnum']; ?>"   class = "box tsize"/><br /><br />
                  <label>Vehicle Model  :</label><input type = "text" name = "vmodel"   value="<?php echo $row['vmodel']; ?>"    class = "box tsize" /><br/><br />
                 

                  <input type = "submit" value = "Submit" name="submit"  class="Cbut"/><br /><br/>
                  <!--<a href="VehiclesDetails.php">View Details</a>-->
                  <!--<input class="win7-btn" type="button" value="Vehicles Details" style="height:50px;width:222px;font-size:20px;" onclick="openVD()"/><div class="clear"></div>-->
...
<!--<script>
 ...
 function openVD() {
  myWindow = window.open("VehiclesDetails.php");
 }
