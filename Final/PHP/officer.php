   ...
   <body bgcolor = "#FFFFFF" style="background-image: url('img/nature.jpg');background-repeat:no-repeat;background-attachment:fixed;background-size:cover;">
      ...
      <div align = "center" >
         <div style = "width:300px; border: solid 1px #333333;" align = "left" class="fposition">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b><center>Vehicles Registration</center></b></div>
				
            <div style = "margin:30px">
               
               <form action ="VProcess.php" method = "post" name="addData" onsubmit="return validateForm()">
                  <label>Fuel Type  :</label><input type = "text" name = "ftype" class = "box tsize"/><br /><br />
                  <label>Endine Type  :</label><input type = "text" name = "etype" class = "box tsize" /><br/><br />
                  <label>License plate number  :</label><input type = "text" name = "lnum" class = "box tsize"/><br /><br />
                  <label>Vehicle Model  :</label><input type = "text" name = "vmodel" class = "box tsize" /><br/><br />
                 

                  <input type = "submit" value = "Submit" name="save"  class="Cbut"/><br /><br/>
